...
<div className="pt-4 md:pt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
  {/* project 1 */}
  <div className="card bg-[#26313F] mx-auto  lg:auto shadow-xl">
    ...
    <div className="">
      ...
      <div className="mt-4 mb-6 flex  justify-center gap-1 lg:gap-4">
        <a
          className="bg-[#55E5A4]  px-2 py-2 rounded-lg font-medium text-gray-800"
